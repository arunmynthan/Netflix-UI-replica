let API = "05517baafd2a403ece47920a85af2ded";

let request = {
  fetchTrending: `https://api.themoviedb.org/3/trending/all/week?api_key=${API}&language=en-US`,
  fetchNeflixOriginals: `https://api.themoviedb.org/3/discover/tv?api_key=${API}&with_networks=213`,
  ...
  fetchDocumentaries: `https://api.themoviedb.org/3/discover/movie?api_key=${API}&with_genres=36`,
};
